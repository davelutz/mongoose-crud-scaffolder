...
function createFileContent(fd, name, pluralName, types, cb) {
  ...
  var headerComment = '\'use strict\';\r\n' +
    ...
    ' **/' + NL + NL;
  var requireBlock = 'var express = require(\'express\');' + NL +
  'var router = express.Router();' + NL +
  'var Model = require(\'../models/model-' + pluralName + '.js\');' + NL + NL;

  var listBlock = '' +
    'router.get(\'/\', function(req, res) {' + NL +
  ...
  var addBlock = '' +
    'router.get(\'/\edit\', function(req, res) {' + NL +
    TAB + 'return res.render(\'' + pluralName + '/\edit\');' + NL + 
    '});' + NL + NL;

  var createBlock = '' +
    'router.post(\'/\', function(req, res) {' + NL +
  ...
  var readBlock = '' +
    'router.get(\'/:id\', function(req, res) {' + NL +
    ...
    '});' + NL + NL;
  var updateBlock = '' +
    'router.put(\'/:id\', function(req, res) {' + NL +
    TAB + 'var id = req.params.id;' + NL +
    TAB + 'Model.findOne({_id: id}, function(err, ' + name + '){' + NL +
    TAB + TAB + 'if (req.accepts(\'html\', \'json\') === \'json\') {' + NL +
    TAB + TAB + TAB + 'if(err) {' + NL +
  ...
  var deleteBlock = '' +
    'router.delete(\'/:id\', function(req, res) {' + NL +
    TAB + 'var id = req.params.id;' + NL +
    TAB + 'Model.remove({_id: id}, function(err, ' + name + '){' + NL +
    TAB + TAB + 'if (req.accepts(\'html\', \'json\') === \'json\') {' + NL +
    TAB + TAB + TAB + 'if(err) {' + NL +
    TAB + TAB + TAB + TAB + 'return res.json(500, {' + NL +
    TAB + TAB + TAB + TAB + TAB + 'message: \'Error getting ' + name + '.\'' + NL +
  ...
  var exportLine = 'module.exports = router;';

  var text = headerComment + requireBlock + listBlock + addBlock + createBlock +
